...
def posts_today(request):
    ...
    return render(request, 'images/current.html', {"date": date,"posts": posts})
...
def past_days_posts(request,past_date):
    ...
    return render(request, 'images/recent.html', {"date": date, "posts": posts})
...
def location(request,location_id):
    ...
    return render(request, 'images/locations.html', {"loc":image})